    ...
    <div class="holder-fluid" style="background: #f1f1f1;text-align: center;padding: 30px 0;box-shadow: inset 0px 0px 20px -2px #c4d0d9;">
        <div class="holder">
            ...
            <div class="breadcumb">
                <a href="index.php">Home</a>
                <a href="advisor.php">Advisor</a>
                <a href="member-details.php">Advisor Details</a>
            </div>
        </div>
    </div>
    <div class="holder-fluid gswa-member-details">
            <div class="holder">
        ...
        <div class="holder">
            ...
            <div class="grid-9">
                <div class="grid-3">Name : </div><div class="grid-9">ABCDE</div>
                <div class="grid-3">Designation : </div><div class="grid-9">Programmer</div>
                <div class="grid-3">Member type  : </div><div class="grid-9">Executive Director</div>
                <div class="grid-3">Member Since  : </div><div class="grid-9">August 2020</div>
                <div class="grid-3">Details : </div><div class="grid-9"></div>
        ...
        <div class="holder">
            ...
            <div class="list-inline">
                <ul class="list-inline">
                    <li> <a href="https://www.facebook.com/gswabd1">facebook</a> </li>
                    <li>twitter</li>
                    <li>google+</li>
                </ul>
            </div>
