...
<body id="body">
    ...
    <div class="body">
            ...
            <br>
            <br>
			<h3 style="background: #f1f1f1;text-align: center;padding: 30px 0;box-shadow: inset 0px 0px 20px -2px #c4d0d9;">You Have Already Registered with this Email!!!!<br></h3>
            <h3 style="background: #f1f1f1;text-align: center;padding: 30px 0;box-shadow: inset 0px 0px 20px -2px #c4d0d9;"> Please Change Email And Try Again!!!<br></h3>
            
            <div class="holder-fluid" style="text-align: center;padding: 30px 0;box-shadow: inset 0px 0px 20px -2px #c4d0d9;">
            <div class="holder">
                <div class="breadcumb">
                    <a href="index.php">Home</a>
                    <a href="login.php">Back to Registration Page</a>
                </div>
            </div>
            <br>
            <br>
