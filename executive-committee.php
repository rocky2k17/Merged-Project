...
<body id="body">
    ...
    <div class="holder-fluid gswa-exec-committee">
        <div class="holder">
                <div class="grid-12 gswa-page-description"></div>
        </div>
        <div class="holder gswa-exec-committee-block">
            <div class="grid-3">
                <h3>Committee<br>2020</h3>
            </div>
            <div class="grid-9">
                <div class="grid-4 gswa-exec-committee-member">
