...
<body id="body">
    ...
    <div class="holder-fluid gswa-events">
        <div class="holder gswa-event">
                <div class="grid-12 gswa-page-description"></div>

            <div class="grid-6 gswa-event-date-left ">
                27 AUGUST
                <br> 2022
            </div>
            <div class="grid-6 gswa-event-title-right">
                <span class="gswa-event-bulet"></span>
                <p>New Committy formation after void the old commity...</p>
            </div>
        </div>
        <div class="holder gswa-event">
            <div class="grid-6 gswa-event-title-left">
                    <p>New Committy formation after void the old commity...</p>
            </div>
            <div class="grid-6 gswa-event-date-right">
                <span class="gswa-event-bulet"></span>
                27 AUGUST
                <br> 2022
            </div>
